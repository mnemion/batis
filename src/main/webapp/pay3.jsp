...
<head>
<meta charset="UTF-8">
<title>사용자 정보 출력 및 결제 API - step3</title>
...
<body>
	...
	고객이메일 : <%=(String)request.getAttribute("buyeremail") %><br>
	<p>--------상품 정보--------</p>
	상품코드 : <%=(String)request.getAttribute("goodcode") %><br>
	상품명 : <%=(String)request.getAttribute("goodname") %><br>
	상품 갯수 : <%=(String)request.getAttribute("goodea") %><br>
	<p>--------배송 정보--------</p>
	수령인 : <%=(String)request.getAttribute("buyername") %><br>
	배송지 : <%=(String)request.getAttribute("rec_post") %><br>
	도로명 주소 : <%=(String)request.getAttribute("rec_addr") %><br>
	상세 주소 : <%=(String)request.getAttribute("rec_addr_dtc") %><br>
	<p>--------결제금액 및 결제수단--------</p>
	최종결제 금액 : <%=(String)request.getAttribute("price") %>원<br>
	결제 수단 : <%=(String)request.getAttribute("gopaymethod") %><br>
	포인트 및 적립금 : <%=(String)request.getAttribute("point") %>원<br>
